...
## Homicide is the N°9th death cause for people between 15 and 49 (2019 Data)
...
# Flow Chart and GE comparison in gender 
## Conclusion (2019 Data)
...
# own model
model_happiness <- lm(homicide_rate ~ life_ladder, data = homicide_happiness_gdp)
...
model <- lm(homicide_rate ~ healthy_life_expectancy_at_birth + social_support + 
